...
// import { aStarWithLevels, aStar } from "./aStar";
...
// const path = aStarWithLevels(nodes, stringMap[0].length, stringMap.length);
// let count = 0
// if (path) {
// 	console.log(path.distance)
// 	let lookUp = path.prev
// 	while(lookUp) {
// 		count++
// 		lookUp = lookUp.prev
// 	}
...
// // 	}
// // });
const t = require('./p2').default.part2(true)()
console.log(t)
// for (const p in t) {
// }